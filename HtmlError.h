...
#define err(ws_error,i_errorLevel)	Utility::HtmlError::ErrorMessage(__FUNCTION__,ws_error,i_errorLevel)
#define alloc(ws_name,l_bytes)		Utility::HtmlError::Allocated(__FUNCTION__,ws_name,l_bytes)
#define dealloc(l_bytes)			Utility::HtmlError::Deallocated(__FUNCTION__,l_bytes)
