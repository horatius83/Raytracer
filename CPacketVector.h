#ifndef CPACKETVECTOR_H
#define CPACKETVECTOR_H
...
namespace NMath
{
	...
	public:
		CPacketVector(){};
		CPacketVector(const CPacketVector& oPacket)
		{
			Set(oPacket);
		}
		...
		inline void DotProduct(__m128& sseAnswer,CPacketVector& oVector)
		{
		...
		inline void Set(const CPacketVector& oPacket)
		{
		...
		inline void Mul(const __m128& sseScalar,const CPacketVector& oPacket)
		{
		...
		inline void Mul(const CPacketVector& oPacketA,const CPacketVector& oPacketB)
		{
		...
		inline void Div(const CPacketVector& oPacket,const __m128& sseScalar)
		{
		...
		inline void Add(const CPacketVector& oPacketA,const CPacketVector& oPacketB)
		{
		...
		inline void Sub(const CPacketVector& oPacket)
		{
