...
namespace Utility 
{
	...
	public:
		...
		inline long		lGetSize(){return sizeof(WindowsTimer);};
	private:
	...
	inline bool WindowsTimer::bInitialize()
	{
	...
	inline unsigned long WindowsTimer::ulGetMilliSeconds(){
		return (unsigned long)((m_i64End-m_i64Start)/m_i64Frequency);
	}

	inline unsigned long WindowsTimer::ulGetSeconds(){
